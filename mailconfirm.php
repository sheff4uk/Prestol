<?
	...
	$query = "SELECT USR_ID, Name, Surname, Email, Mailconfirm FROM Users WHERE Login = '{$login}'";
	...
	if ($mailconfirm == $code) {//сравниваем полученный из url и сгенерированный код
		if ($myrow['Mailconfirm'] == 1) {
			echo "Ваш E-mail уже был подтвержден ранее. <b>Повторное подтверждение не требуется!</b>";
		}
		else {
