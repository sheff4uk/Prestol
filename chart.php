...
$diff_week = round($current_power_week/$last_power_week*100, 3) - 100;
$diff_month = round($current_power_month/$last_power_month*100, 3) - 100;
$diff_quarter = round($current_power_quarter/$last_power_quarter*100, 3) - 100;
