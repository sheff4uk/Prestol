...
if ( $row["value"] == "1" ) {
	...
	$url = 'https://kis.konstanta.ltd/printforms/proxy_prestol.php?doc=doverennost';
	...
	// $content = file_get_contents('https://service-online.su/forms/doverennost_TMC/blanc.php', false, $headers);
