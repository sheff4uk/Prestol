...
if ( $row["value"] == "1" ) {
	...
	$url = 'https://kis.konstanta.ltd/printforms/proxy_prestol.php?doc=upd';
	...
	// $content = file_get_contents('https://service-online.su/forms/buh/upd/blanc.php', false, $headers);
