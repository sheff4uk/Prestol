<?
	...
	if ($result2=='TRUE')
	{
		...
		if ($mail->send()) {//отправляем сообщение
			echo "На Ваш E-mail <b>{$email}</b> выслано письмо со cсылкой, для подтверждения регистрации. Внимание! Ссылка действительна 1 час. <a href='/'>Главная страница</a>"; //говорим об отправленном письме пользователю
		}
		else {
			exit ("Ошибка! Письмо не отправлено. Свяжитесь с администрацией <b>admin@fabrikaprestol.ru</b>");
		}
	}
	else {
