<?
	...
	if ($result2=='TRUE')
	{
		...
		if (!mail($email, $subject, $message, "Content-type:text/plane; Charset=windows-1251\r\n")) {//отправляем сообщение
			exit ("Письмо не отправлено!");
		}

		echo "Вам на E-mail выслано письмо со cсылкой, для подтверждения регистрации. Внимание! Ссылка действительна 1 час. <a href='/'>Главная страница</a>"; //говорим о отправленном письме пользователю
