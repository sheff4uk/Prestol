	...
	<div class="halfblock">
		...
		<table>
			...
			<tr>
				...
				<th>В покраске</th>
				<th title="Кол-во заготовок, необходимое для производства текущих наборов. Через дробь указано сколько нужно заготовок под прозрачное покрытие.">Требуется<i class="fa fa-question-circle" aria-hidden="true"></i></th>
			</tr>
			</thead>
